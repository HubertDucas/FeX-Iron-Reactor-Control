...
gamma_n, w_n_l = 0.75, Hz2rps(5)
gamma_r, w_r_h = 0.05, Hz2rps(0.005)
gamma_u, w_u_l = 0.0682, Hz2rps(5)
...
def simulate(t, Tout_bar, Tout_init, noise):
    ...
    # P_nom and controller in state-space form
    ...
    def closed_loop(t, x):
        ...
        # plant matrices at current time
